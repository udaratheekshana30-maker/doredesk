...
export const AuthProvider = ({ children }) => {
    ...
    const login = (userData) => {
        ...
        } else if (userData.role?.toLowerCase() === 'laundryadmin') {
            navigate('/warden/laundry');
        } else if (userData.role?.toLowerCase() === 'resourceadmin') {
            navigate('/warden/resources');
        } else if (userData.role?.toLowerCase() === 'roombookingadmin') {
