            ...
            <div className="tab-content">
                {activeTab === 'rooms' ? (
                    ...
                    <div className="space-y-16">
                        {/* 2. Booking Management Table (Main Section) */}
                        <section className="space-y-6">
                            <div className="flex items-center gap-3">
                                <div className="w-1.5 h-8 bg-[#FAB95B] rounded-full"></div>
                                <h3 className="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Booking Management</h3>
                            </div>
                            <BookingManagementTable 
                                onAllocateManually={() => navigate('/student-applications')}
                            />
                        </section>

                        {/* Visual Room Allocation Map (Moved below table as requested) */}
                        <section className="space-y-6">
                            <div className="flex items-center gap-3">
                                <div className="w-1.5 h-8 bg-indigo-500 rounded-full"></div>
                                <h3 className="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Visual Occupancy Map</h3>
                            </div>
                            <RoomAllocation 
